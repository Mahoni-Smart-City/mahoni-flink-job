...
public class TripSchema extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  ...
  public static TripSchema fromByteBuffer(
   ...
   private String scanInPlaceId;
   private long scanInTimestamp;
   private String scanOutPlaceId;
   ...
   */
  public TripSchema(String eventId, Long timestamp, String tripId, String userId, String scanInPlaceId, Long scanInTimestamp, String scanOutPlaceId, Long scanOutTimestamp, String status, Double aqi, Integer point) {
  ...
  public void put(int field$, Object value$) {
    ...
    case 5: scanInTimestamp = (Long)value$; break;
    case 6: scanOutPlaceId = value$ != null ? value$.toString() : null; break;
    case 7: scanOutTimestamp = (Long)value$; break;
    case 8: status = value$ != null ? value$.toString() : null; break;
    case 9: aqi = (Double)value$; break;
    case 10: point = (Integer)value$; break;
    default: throw new IndexOutOfBoundsException("Invalid index: " + field$);
    }
  }
   ...
   */
  public String getScanInPlaceId() {
   ...
   * @param value the value to set.
   */
  public void setScanInPlaceId(String value) {
   ...
   */
  public String getScanOutPlaceId() {
   ...
   * @param value the value to set.
   */
  public void setScanOutPlaceId(String value) {
   ...
   * @return A new TripSchema RecordBuilder
   */
  public static Builder newBuilder(TripSchema other) {
    if (other == null) {
      return new Builder();
    } else {
      return new Builder(other);
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<TripSchema>
     ...
     * @param other The existing instance to copy.
     */
    private Builder(TripSchema other) {
      super(SCHEMA$);
      if (isValidValue(fields()[0], other.eventId)) {
        this.eventId = data().deepCopy(fields()[0].schema(), other.eventId);
    ...
    /**
      ...
      * @return This builder.
      */
    public Builder setScanInPlaceId(String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public Builder clearScanInPlaceId() {
      scanInPlaceId = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public Builder setScanInTimestamp(long value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public Builder clearScanInTimestamp() {
    ...
    /**
      ...
      * @return This builder.
      */
    public Builder setScanOutPlaceId(String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public Builder clearScanOutPlaceId() {
      scanOutPlaceId = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public Builder setScanOutTimestamp(Long value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public Builder clearScanOutTimestamp() {
    ...
    /**
      ...
      * @return This builder.
      */
    public Builder setPoint(Integer value) {
    ...
    public TripSchema build() {
      try {
        ...
        record.tripId = fieldSetFlags()[2] ? this.tripId : (String) defaultValue(fields()[2]);
        record.userId = fieldSetFlags()[3] ? this.userId : (String) defaultValue(fields()[3]);
        record.scanInPlaceId = fieldSetFlags()[4] ? this.scanInPlaceId : (String) defaultValue(fields()[4]);
        record.scanInTimestamp = fieldSetFlags()[5] ? this.scanInTimestamp : (Long) defaultValue(fields()[5]);
        record.scanOutPlaceId = fieldSetFlags()[6] ? this.scanOutPlaceId : (String) defaultValue(fields()[6]);
        record.scanOutTimestamp = fieldSetFlags()[7] ? this.scanOutTimestamp : (Long) defaultValue(fields()[7]);
        record.status = fieldSetFlags()[8] ? this.status : (String) defaultValue(fields()[8]);
        record.aqi = fieldSetFlags()[9] ? this.aqi : (Double) defaultValue(fields()[9]);
        record.point = fieldSetFlags()[10] ? this.point : (Integer) defaultValue(fields()[10]);
        return record;
