...
public class VoucherRedeemedSchema extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
     ...
     */
    public VoucherRedeemedSchema(java.lang.String eventId, java.lang.Long timestamp, java.lang.String voucherId, java.lang.String userId, java.lang.String code, java.lang.Integer point, java.lang.Long redeemedAt, java.lang.Long expiredAt) {
    ...
    public void put(int field$, java.lang.Object value$) {
        switch (field$) {
            ...
            case 5: point = (java.lang.Integer)value$; break;
            case 6: redeemedAt = (java.lang.Long)value$; break;
            case 7: expiredAt = (java.lang.Long)value$; break;
            default: throw new IndexOutOfBoundsException("Invalid index: " + field$);
        }
    }
     ...
     * @param value the value to set.
     */
    public void setVoucherId(java.lang.String value) {
     ...
     */
    public static com.mahoni.schema.VoucherRedeemedSchema.Builder newBuilder() {
        return new com.mahoni.schema.VoucherRedeemedSchema.Builder();
    }
     ...
     * @return A new VoucherRedeemedSchema RecordBuilder
     */
    public static com.mahoni.schema.VoucherRedeemedSchema.Builder newBuilder(com.mahoni.schema.VoucherRedeemedSchema.Builder other) {
        if (other == null) {
            return new com.mahoni.schema.VoucherRedeemedSchema.Builder();
        } else {
            return new com.mahoni.schema.VoucherRedeemedSchema.Builder(other);
        }
    }
     ...
     * @return A new VoucherRedeemedSchema RecordBuilder
     */
    public static com.mahoni.schema.VoucherRedeemedSchema.Builder newBuilder(com.mahoni.schema.VoucherRedeemedSchema other) {
        if (other == null) {
            return new com.mahoni.schema.VoucherRedeemedSchema.Builder();
        } else {
            return new com.mahoni.schema.VoucherRedeemedSchema.Builder(other);
    ...
    public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<VoucherRedeemedSchema>
         ...
         * @param other The existing Builder to copy.
         */
        private Builder(com.mahoni.schema.VoucherRedeemedSchema.Builder other) {
            super(other);
         ...
         * @param other The existing instance to copy.
         */
        private Builder(com.mahoni.schema.VoucherRedeemedSchema other) {
            super(SCHEMA$);
            if (isValidValue(fields()[0], other.eventId)) {
                this.eventId = data().deepCopy(fields()[0].schema(), other.eventId);
         ...
         * @return This builder.
         */
        public com.mahoni.schema.VoucherRedeemedSchema.Builder setEventId(java.lang.String value) {
         ...
         * @return This builder.
         */
        public com.mahoni.schema.VoucherRedeemedSchema.Builder clearEventId() {
            eventId = null;
         ...
         * @return This builder.
         */
        public com.mahoni.schema.VoucherRedeemedSchema.Builder setTimestamp(long value) {
         ...
         * @return This builder.
         */
        public com.mahoni.schema.VoucherRedeemedSchema.Builder clearTimestamp() {
         ...
         * @return This builder.
         */
        public com.mahoni.schema.VoucherRedeemedSchema.Builder setVoucherId(java.lang.String value) {
         ...
         * @return This builder.
         */
        public com.mahoni.schema.VoucherRedeemedSchema.Builder clearVoucherId() {
            voucherId = null;
         ...
         * @return This builder.
         */
        public com.mahoni.schema.VoucherRedeemedSchema.Builder setUserId(java.lang.String value) {
         ...
         * @return This builder.
         */
        public com.mahoni.schema.VoucherRedeemedSchema.Builder clearUserId() {
            userId = null;
         ...
         * @return This builder.
         */
        public com.mahoni.schema.VoucherRedeemedSchema.Builder setCode(java.lang.String value) {
         ...
         * @return This builder.
         */
        public com.mahoni.schema.VoucherRedeemedSchema.Builder clearCode() {
            code = null;
         ...
         * @return This builder.
         */
        public com.mahoni.schema.VoucherRedeemedSchema.Builder setPoint(int value) {
         ...
         * @return This builder.
         */
        public com.mahoni.schema.VoucherRedeemedSchema.Builder clearPoint() {
         ...
         * @return This builder.
         */
        public com.mahoni.schema.VoucherRedeemedSchema.Builder setRedeemedAt(long value) {
         ...
         * @return This builder.
         */
        public com.mahoni.schema.VoucherRedeemedSchema.Builder clearRedeemedAt() {
         ...
         * @return This builder.
         */
        public com.mahoni.schema.VoucherRedeemedSchema.Builder setExpiredAt(long value) {
         ...
         * @return This builder.
         */
        public com.mahoni.schema.VoucherRedeemedSchema.Builder clearExpiredAt() {
        ...
        public VoucherRedeemedSchema build() {
            try {
                ...
                record.voucherId = fieldSetFlags()[2] ? this.voucherId : (java.lang.String) defaultValue(fields()[2]);
                record.userId = fieldSetFlags()[3] ? this.userId : (java.lang.String) defaultValue(fields()[3]);
                record.code = fieldSetFlags()[4] ? this.code : (java.lang.String) defaultValue(fields()[4]);
                record.point = fieldSetFlags()[5] ? this.point : (java.lang.Integer) defaultValue(fields()[5]);
                record.redeemedAt = fieldSetFlags()[6] ? this.redeemedAt : (java.lang.Long) defaultValue(fields()[6]);
                record.expiredAt = fieldSetFlags()[7] ? this.expiredAt : (java.lang.Long) defaultValue(fields()[7]);
                return record;
